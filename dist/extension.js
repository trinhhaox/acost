"use strict";var Ne=Object.create;var ne=Object.defineProperty;var Ae=Object.getOwnPropertyDescriptor;var Re=Object.getOwnPropertyNames;var Ie=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var Le=(a,e)=>{for(var t in e)ne(a,t,{get:e[t],enumerable:!0})},ke=(a,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of Re(e))!Ue.call(a,o)&&o!==t&&ne(a,o,{get:()=>e[o],enumerable:!(i=Ae(e,o))||i.enumerable});return a};var A=(a,e,t)=>(t=a!=null?Ne(Ie(a)):{},ke(e||!a||!a.__esModule?ne(t,"default",{value:a,enumerable:!0}):t,a)),Ve=a=>ke(ne({},"__esModule",{value:!0}),a);var Ge={};Le(Ge,{activate:()=>Oe,deactivate:()=>He});module.exports=Ve(Ge);var v=A(require("vscode")),z=A(require("fs")),me=A(require("path")),Te=A(require("os"));var L=A(require("fs")),$=A(require("path")),ge=A(require("os"));var Fe={"gemini-3.7-flash":{displayName:"Gemini 3.7 Flash",provider:"Google",inputPricePerMillion:.15,outputPricePerMillion:.6,cacheReadPricePerMillion:.0375},"gemini-3.6-flash":{displayName:"Gemini 3.6 Flash",provider:"Google",inputPricePerMillion:.15,outputPricePerMillion:.6,cacheReadPricePerMillion:.0375},"gemini-3.5-flash":{displayName:"Gemini 3.5 Flash",provider:"Google",inputPricePerMillion:.1,outputPricePerMillion:.4,cacheReadPricePerMillion:.025},"gemini-3.1-pro":{displayName:"Gemini 3.1 Pro",provider:"Google",inputPricePerMillion:1.25,outputPricePerMillion:5,cacheReadPricePerMillion:.3125},"gemini-2.5-pro":{displayName:"Gemini 2.5 Pro",provider:"Google",inputPricePerMillion:1.25,outputPricePerMillion:5,cacheReadPricePerMillion:.3125},"gemini-2.5-flash":{displayName:"Gemini 2.5 Flash",provider:"Google",inputPricePerMillion:.075,outputPricePerMillion:.3,cacheReadPricePerMillion:.01875},"gemini-1.5-pro":{displayName:"Gemini 1.5 Pro",provider:"Google",inputPricePerMillion:1.25,outputPricePerMillion:5,cacheReadPricePerMillion:.3125},"gemini-1.5-flash":{displayName:"Gemini 1.5 Flash",provider:"Google",inputPricePerMillion:.075,outputPricePerMillion:.3,cacheReadPricePerMillion:.01875},"claude-opus-5":{displayName:"Claude Opus 5",provider:"Anthropic",inputPricePerMillion:15,outputPricePerMillion:75,cacheReadPricePerMillion:1.5},"claude-opus-4.8":{displayName:"Claude Opus 4.8",provider:"Anthropic",inputPricePerMillion:15,outputPricePerMillion:75,cacheReadPricePerMillion:1.5},"claude-opus-4.7":{displayName:"Claude Opus 4.7",provider:"Anthropic",inputPricePerMillion:15,outputPricePerMillion:75,cacheReadPricePerMillion:1.5},"claude-opus-4.6":{displayName:"Claude Opus 4.6 (Thinking)",provider:"Anthropic",inputPricePerMillion:15,outputPricePerMillion:75,cacheReadPricePerMillion:1.5},"claude-3-opus":{displayName:"Claude 3 Opus",provider:"Anthropic",inputPricePerMillion:15,outputPricePerMillion:75,cacheReadPricePerMillion:1.5},"claude-sonnet-4.6":{displayName:"Claude Sonnet 4.6 (Thinking)",provider:"Anthropic",inputPricePerMillion:3,outputPricePerMillion:15,cacheReadPricePerMillion:.3},"claude-sonnet-4.5":{displayName:"Claude Sonnet 4.5",provider:"Anthropic",inputPricePerMillion:3,outputPricePerMillion:15,cacheReadPricePerMillion:.3},"claude-3.7-sonnet":{displayName:"Claude 3.7 Sonnet",provider:"Anthropic",inputPricePerMillion:3,outputPricePerMillion:15,cacheReadPricePerMillion:.3},"claude-3.5-sonnet":{displayName:"Claude 3.5 Sonnet",provider:"Anthropic",inputPricePerMillion:3,outputPricePerMillion:15,cacheReadPricePerMillion:.3},"claude-haiku-4.5":{displayName:"Claude Haiku 4.5",provider:"Anthropic",inputPricePerMillion:.8,outputPricePerMillion:4,cacheReadPricePerMillion:.08},"claude-3.5-haiku":{displayName:"Claude 3.5 Haiku",provider:"Anthropic",inputPricePerMillion:.8,outputPricePerMillion:4,cacheReadPricePerMillion:.08},"claude-fable-5":{displayName:"Claude Fable 5",provider:"Anthropic",inputPricePerMillion:3,outputPricePerMillion:15,cacheReadPricePerMillion:.3},"gpt-4o":{displayName:"GPT-4o",provider:"OpenAI",inputPricePerMillion:2.5,outputPricePerMillion:10,cacheReadPricePerMillion:1.25},"gpt-4o-mini":{displayName:"GPT-4o mini",provider:"OpenAI",inputPricePerMillion:.15,outputPricePerMillion:.6,cacheReadPricePerMillion:.075},"o3-mini":{displayName:"o3-mini",provider:"OpenAI",inputPricePerMillion:1.1,outputPricePerMillion:4.4,cacheReadPricePerMillion:.55},o1:{displayName:"o1",provider:"OpenAI",inputPricePerMillion:15,outputPricePerMillion:60,cacheReadPricePerMillion:7.5},default:{displayName:"Standard AI Model",provider:"Other",inputPricePerMillion:.5,outputPricePerMillion:1.5,cacheReadPricePerMillion:.1}},K=class{pricingTable;config;constructor(e){if(this.config=e,this.pricingTable={...Fe},e.customPricing)for(let[t,i]of Object.entries(e.customPricing))this.pricingTable[t]?this.pricingTable[t]={...this.pricingTable[t],...i}:i.inputPricePerMillion!==void 0&&i.outputPricePerMillion!==void 0&&(this.pricingTable[t]={displayName:i.displayName||t,provider:i.provider||"Other",inputPricePerMillion:i.inputPricePerMillion,outputPricePerMillion:i.outputPricePerMillion,cacheReadPricePerMillion:i.cacheReadPricePerMillion||0})}normalizeModelKey(e){if(!e)return"gemini-3.7-flash";let t=e.toLowerCase();return t.includes("3.7")&&t.includes("flash")?"gemini-3.7-flash":t.includes("3.6")&&t.includes("flash")?"gemini-3.6-flash":t.includes("3.5")&&t.includes("flash")?"gemini-3.5-flash":t.includes("3.1")&&t.includes("pro")?"gemini-3.1-pro":t.includes("2.5")&&t.includes("pro")?"gemini-2.5-pro":t.includes("2.5")&&t.includes("flash")?"gemini-2.5-flash":t.includes("1.5")&&t.includes("pro")?"gemini-1.5-pro":t.includes("1.5")&&t.includes("flash")?"gemini-1.5-flash":t.includes("claude-opus-5")||t.includes("opus-5")?"claude-opus-5":t.includes("claude-opus-4-8")||t.includes("claude-opus-4.8")?"claude-opus-4.8":t.includes("claude-opus-4-7")||t.includes("claude-opus-4.7")?"claude-opus-4.7":t.includes("claude-opus-4-6")||t.includes("claude-opus-4.6")||t.includes("opus")&&t.includes("4.6")?"claude-opus-4.6":t.includes("claude-3-opus")||t.includes("claude-3.0-opus")?"claude-3-opus":t.includes("claude-sonnet-4-6")||t.includes("claude-sonnet-4.6")||t.includes("sonnet")&&t.includes("4.6")?"claude-sonnet-4.6":t.includes("claude-sonnet-4-5")||t.includes("claude-sonnet-4.5")||t.includes("sonnet")&&t.includes("4.5")?"claude-sonnet-4.5":t.includes("claude-3-7-sonnet")||t.includes("claude-3.7-sonnet")||t.includes("sonnet")&&t.includes("3.7")?"claude-3.7-sonnet":t.includes("claude-3-5-sonnet")||t.includes("claude-3.5-sonnet")||t.includes("sonnet")&&t.includes("3.5")?"claude-3.5-sonnet":t.includes("claude-haiku-4-5")||t.includes("claude-haiku-4.5")||t.includes("haiku")&&t.includes("4.5")?"claude-haiku-4.5":t.includes("claude-3-5-haiku")||t.includes("claude-3.5-haiku")||t.includes("claude-haiku")?"claude-3.5-haiku":t.includes("claude-fable-5")||t.includes("fable")?"claude-fable-5":t.includes("claude")&&t.includes("opus")?"claude-3-opus":t.includes("claude")&&t.includes("sonnet")?"claude-3.7-sonnet":t.includes("claude")&&t.includes("haiku")?"claude-3.5-haiku":t.includes("gpt-4o-mini")||t.includes("4o-mini")?"gpt-4o-mini":t.includes("gpt-4o")||t.includes("4o")?"gpt-4o":t.includes("o3-mini")?"o3-mini":t.includes("o1")?"o1":t.includes("gemini")?"gemini-3.7-flash":t.includes("claude")?"claude-3.7-sonnet":t.includes("gpt")?"gpt-4o":"default"}getModelPricing(e){let t=this.normalizeModelKey(e);return this.pricingTable[t]||this.pricingTable.default}calculateCostUSD(e,t,i,o=0,u=0,l=0){let r=this.getModelPricing(e),s=i+o,n=t/1e6*r.inputPricePerMillion,c=s/1e6*r.outputPricePerMillion,g=r.cacheReadPricePerMillion!==void 0?r.cacheReadPricePerMillion:r.inputPricePerMillion*.1,S=l/1e6*g,D=u/1e6*(r.inputPricePerMillion*1.25);return n+c+S+D}usdToVnd(e){return Math.round(e*this.config.vndExchangeRate)}calculateValuation(e,t,i,o){let u=this.usdToVnd(e),l=t/3600,r=Math.max(1,Math.round((l*4.5+i/5e4*1.5)*10)/10),s=this.config.humanHourlyRate,n=Math.round(r*s),c=this.usdToVnd(n),g=s*.6,S=l*g,D=Math.round((e*this.config.markupMultiplier+S+o*.5)*100)/100,I=this.usdToVnd(D),w=Math.max(0,n-D),C=this.usdToVnd(w);return{apiCostUSD:Math.round(e*1e4)/1e4,apiCostVND:u,humanHoursEquivalent:r,humanHourlyRate:s,humanCostEquivalentUSD:n,humanCostEquivalentVND:c,markupMultiplier:this.config.markupMultiplier,recommendedValuationUSD:D,recommendedValuationVND:I,savingsUSD:w,savingsVND:C}}};var ie=A(require("fs")),W=A(require("path")),Pe=A(require("readline"));var O=class{static estimateTokens(e){if(!e||e.length===0)return 0;let t=e.length;if(t<4)return 1;let i=0,o=0,u=0;for(let c=0;c<Math.min(t,2e3);c++){let g=e.charCodeAt(c);g>255?i++:g===32||g===10||g===9||g===13?u++:(g>=33&&g<=47||g>=58&&g<=64||g>=91&&g<=96||g>=123&&g<=126)&&o++}let l=Math.min(t,2e3),r=i/l,s=o/l,n=3.8;return r>.15?n=2.6:s>.25&&(n=3.3),Math.ceil(t/n)}static estimateObjectTokens(e){if(!e)return 0;try{let t=typeof e=="string"?e:JSON.stringify(e);return this.estimateTokens(t)}catch{return 0}}};var Y=class{pricingEngine;constructor(e){this.pricingEngine=e}async parseFile(e,t){if(!ie.existsSync(e))return null;let i=W.basename(W.dirname(W.dirname(e))),o=ie.createReadStream(e,{encoding:"utf8"}),u=Pe.createInterface({input:o,crlfDelay:1/0}),l="",r="",s="gemini-3.7-flash",n=new Set,c=new Set,g=0,S=0,D=0,I=0,w=null,C=null,E=0,R=null;for await(let p of u)if(p.trim())try{let h=JSON.parse(p),x=h.type||"",f=h.source||"",m=h.content||"",b=h.created_at,k=null;if(b){let T=new Date(b).getTime();if(!isNaN(T)){if(k=T,(w===null||T<w)&&(w=T),(C===null||T>C)&&(C=T),R!==null){let M=(T-R)/1e3;M>0&&M<300&&(E+=M)}R=T}}if(m.includes("Model Selection")||m.includes("USER_SETTINGS_CHANGE")){let T=m.match(/Model Selection` from [^\n]+? to (.+?)\.\s*No need/i)||m.match(/Model Selection` from [^\n]+? to ([^\.\n<]+)/i)||m.match(/setting `Model Selection` from [^\n]+? to ([^\n<]+)/i);if(T&&T[1]){let M=T[1].trim();s=this.pricingEngine.normalizeModelKey(M),n.add(s)}}if(!l){let T=m.match(/\[URI\] -> \[CorpusName\]:\s*([^\s\n]+)/);if(T&&T[1])l=T[1].trim();else{let M=m.match(/Active Document:\s*([^\n\r]+)/);if(M&&M[1]){let U=M[1].trim();l=W.dirname(U)}else{let U=m.match(/@\[([^\]]+)\]/);if(U&&U[1]){let ye=U[1].trim();ye.startsWith("/")&&(l=ye)}}}}if(x==="USER_INPUT"&&!r){let T=m.match(/<USER_REQUEST>([\s\S]*?)<\/USER_REQUEST>/);T&&T[1]?r=T[1].trim().replace(/\n+/g," ").slice(0,80):r=m.replace(/<[^>]+>/g,"").trim().slice(0,80)}if(x==="USER_INPUT")I++,g+=O.estimateTokens(m);else if(x==="KNOWLEDGE_ARTIFACTS"||x==="CONVERSATION_HISTORY"||x==="SYSTEM_MESSAGE"||x==="VIEW_FILE"||x==="GREP_SEARCH"||x==="LIST_DIRECTORY"||x==="RUN_COMMAND"||x==="READ_URL_CONTENT"||x==="MCP_TOOL")g+=O.estimateTokens(m);else if(x==="PLANNER_RESPONSE"){if(h.thinking&&(D+=O.estimateTokens(h.thinking)),m&&(S+=O.estimateTokens(m)),h.tool_calls&&Array.isArray(h.tool_calls))for(let T of h.tool_calls){S+=O.estimateObjectTokens(T);let M=T.args||{},U=M.AbsolutePath||M.TargetFile||M.DirectoryPath;U&&typeof U=="string"&&U.startsWith("/")&&c.add(U.replace(/^"|"$/g,""))}}else f==="MODEL"?S+=O.estimateTokens(m):g+=O.estimateTokens(m)}catch{}if(n.size===0&&n.add(s),t&&l){let p=W.normalize(t).toLowerCase(),h=W.normalize(l).toLowerCase();if(!(h.startsWith(p)||p.startsWith(h)))return null}let j=w&&C?Math.max(1,Math.round((C-w)/1e3)):Math.max(1,Math.round(E)),B=Math.min(j,Math.max(15,Math.round(E))),_=Array.from(n)[0]||"gemini-3.7-flash",G=this.pricingEngine.calculateCostUSD(_,g,S,D),d=this.pricingEngine.usdToVnd(G);return{sessionId:i,workspacePath:l||t||"Unknown Workspace",title:r||`Session ${i.slice(0,8)}`,startTime:w?new Date(w).toISOString():new Date().toISOString(),endTime:C?new Date(C).toISOString():new Date().toISOString(),durationSeconds:j,activeTimeSeconds:B,modelsUsed:Array.from(n),turnsCount:Math.max(1,I),inputTokens:g,outputTokens:S,thinkingTokens:D,totalTokens:g+S+D,costUSD:Math.round(G*1e4)/1e4,costVND:d,filesTouched:Array.from(c),filePath:e}}};var oe=A(require("fs")),V=A(require("path")),Ce=A(require("readline")),Q=class{pricingEngine;constructor(e){this.pricingEngine=e}async parseFile(e,t){if(!oe.existsSync(e))return null;let i=V.basename(e,".jsonl"),o=oe.createReadStream(e,{encoding:"utf8"}),u=Ce.createInterface({input:o,crlfDelay:1/0}),l="",r="",s="claude-3.7-sonnet",n=new Set,c=new Set,g=0,S=0,D=0,I=0,w=0,C=null,E=null,R=0,j=null;for await(let f of u)if(f.trim())try{let m=JSON.parse(f);if(m.timestamp){let b=new Date(m.timestamp).getTime();if(!isNaN(b)){if((C===null||b<C)&&(C=b),(E===null||b>E)&&(E=b),j!==null){let k=(b-j)/1e3;k>0&&k<300&&(R+=k)}j=b}}if(m.cwd&&!l&&(l=m.cwd),m.type==="user"&&m.message){w++;let b=m.message.content,k="";typeof b=="string"?k=b:Array.isArray(b)&&(k=b.map(T=>typeof T=="string"?T:T?.text||"").filter(Boolean).join(" ")),k&&!r&&!k.startsWith("Context: This summary will")&&!k.startsWith("Warmup")&&(r=k.replace(/<[^>]+>/g,"").trim().replace(/\n+/g," ").slice(0,80))}if(m.message){let b=s;if(m.message.model&&m.message.model!=="<synthetic>"){let k=this.pricingEngine.normalizeModelKey(m.message.model);b=k,s=k}if(m.message.usage){let k=m.message.usage.input_tokens||0,T=m.message.usage.output_tokens||0,M=m.message.usage.cache_creation_input_tokens||0,U=m.message.usage.cache_read_input_tokens||0;g+=k,S+=T,D+=M,I+=U,n.add(b)}}if(m.type==="assistant"&&m.message&&Array.isArray(m.message.content)){for(let b of m.message.content)if(b.type==="tool_use"&&b.input){let k=b.input.file_path||b.input.path||b.input.filePath||b.input.targetFile||b.input.TargetFile||b.input.AbsolutePath;k&&typeof k=="string"&&k.startsWith("/")&&c.add(k)}}}catch{}n.size===0&&n.add(s);let B=g+S+D+I;if(B===0&&w===0)return null;if(t&&l){let f=V.normalize(t).toLowerCase(),m=V.normalize(l).toLowerCase();if(!(m===f||m.startsWith(f+V.sep)||f.startsWith(m+V.sep)||V.basename(m)&&V.basename(m)===V.basename(f)))return null}let _=C&&E?Math.max(1,Math.round((E-C)/1e3)):Math.max(1,Math.round(R)),G=Math.min(_,Math.max(10,Math.round(R))),d=Array.from(n),p=d[0]||"claude-sonnet-4.5";for(let f of d){if(f.includes("opus")){p=f;break}f.includes("sonnet")&&(p=f)}let h=this.pricingEngine.calculateCostUSD(p,g,S,0,D,I),x=this.pricingEngine.usdToVnd(h);return{sessionId:i,workspacePath:l||t||"Unknown Workspace",title:r||`Claude Code Session ${i.slice(0,8)}`,startTime:C?new Date(C).toISOString():new Date().toISOString(),endTime:E?new Date(E).toISOString():new Date().toISOString(),durationSeconds:_,activeTimeSeconds:G,modelsUsed:d,turnsCount:Math.max(1,w),inputTokens:g,outputTokens:S,thinkingTokens:0,totalTokens:B,costUSD:Math.round(h*1e4)/1e4,costVND:x,filesTouched:Array.from(c),filePath:e}}};var se=class{pricingEngine;parser;claudeParser;brainDir;claudeProjectsDir;cache=new Map;constructor(e,t,i){this.pricingEngine=new K(e),this.parser=new Y(this.pricingEngine),this.claudeParser=new Q(this.pricingEngine),this.brainDir=t||$.join(ge.homedir(),".gemini","antigravity-ide","brain"),this.claudeProjectsDir=i||$.join(ge.homedir(),".claude","projects")}updateConfig(e){this.pricingEngine=new K(e),this.parser=new Y(this.pricingEngine),this.claudeParser=new Q(this.pricingEngine),this.cache.clear()}async scanWorkspace(e,t="all"){let i=e?$.basename(e):"All Projects",o=[],u=new Map;if(L.existsSync(this.brainDir))try{let d=L.readdirSync(this.brainDir);for(let p of d){let h=$.join(this.brainDir,p,".system_generated","logs","transcript.jsonl");if(L.existsSync(h))try{let x=L.statSync(h),f=this.cache.get(h),m=null;f&&f.mtime===x.mtimeMs?m=f.data:(m=await this.parser.parseFile(h),this.cache.set(h,{mtime:x.mtimeMs,data:m})),m&&(o.push(m),this.recordProjectSummary(u,m))}catch{}}}catch{}if(L.existsSync(this.claudeProjectsDir))try{let d=L.readdirSync(this.claudeProjectsDir);for(let p of d){let h=$.join(this.claudeProjectsDir,p);try{if(!L.statSync(h).isDirectory())continue;let f=L.readdirSync(h).filter(m=>m.endsWith(".jsonl"));for(let m of f){let b=$.join(h,m);try{let k=L.statSync(b),T=this.cache.get(b),M=null;T&&T.mtime===k.mtimeMs?M=T.data:(M=await this.claudeParser.parseFile(b),this.cache.set(b,{mtime:k.mtimeMs,data:M})),M&&(o.push(M),this.recordProjectSummary(u,M))}catch{}}}catch{}}}catch{}let l=[];for(let[d,p]of u.entries())l.push({workspacePath:d,projectName:d==="Unknown"?"Unknown Project":$.basename(d),totalSessions:p.sessions,totalTokens:p.tokens,totalCostUSD:Math.round(p.costUSD*1e4)/1e4,totalCostVND:this.pricingEngine.usdToVnd(p.costUSD),lastActive:p.lastActive});l.sort((d,p)=>p.totalCostUSD-d.totalCostUSD);let r=o;e&&e!=="ALL"&&e!=="All Projects"&&(r=o.filter(d=>this.isWorkspaceMatch(d.workspacePath,e)));let s=Date.now();if(t==="today"){let d=new Date;d.setHours(0,0,0,0);let p=d.getTime();r=r.filter(h=>new Date(h.startTime).getTime()>=p)}else if(t==="7d"){let d=s-6048e5;r=r.filter(p=>new Date(p.startTime).getTime()>=d)}else if(t==="30d"){let d=s-2592e6;r=r.filter(p=>new Date(p.startTime).getTime()>=d)}r.sort((d,p)=>new Date(p.startTime).getTime()-new Date(d.startTime).getTime());let n=0,c=0,g=0,S=0,D=0,I=0,w=0,C=new Map,E=new Map;for(let d of r){n+=d.inputTokens,c+=d.outputTokens,g+=d.thinkingTokens,S+=d.costUSD,D+=d.activeTimeSeconds,I+=d.durationSeconds,w+=d.turnsCount;for(let p of d.modelsUsed){let h=C.get(p)||{input:0,output:0,thinking:0,costUSD:0},x=1/d.modelsUsed.length;h.input+=Math.round(d.inputTokens*x),h.output+=Math.round(d.outputTokens*x),h.thinking+=Math.round(d.thinkingTokens*x),h.costUSD+=d.costUSD*x,C.set(p,h)}if(d.filesTouched&&d.filesTouched.length>0){let p=Math.round(d.totalTokens/d.filesTouched.length),h=d.costUSD/d.filesTouched.length;for(let x of d.filesTouched){let f=E.get(x)||{count:0,estimatedTokens:0,costUSD:0};f.count++,f.estimatedTokens+=p,f.costUSD+=h,E.set(x,f)}}}let R=n+c+g,j=this.pricingEngine.usdToVnd(S),B=[];for(let[d,p]of C.entries()){let h=this.pricingEngine.getModelPricing(d),x=p.input+p.output+p.thinking;B.push({modelName:d,displayName:h.displayName||d,provider:h.provider||"Other",inputTokens:p.input,outputTokens:p.output,thinkingTokens:p.thinking,totalTokens:x,costUSD:Math.round(p.costUSD*1e4)/1e4,costVND:this.pricingEngine.usdToVnd(p.costUSD),percentageOfCost:S>0?Math.round(p.costUSD/S*1e3)/10:0,percentageOfTokens:R>0?Math.round(x/R*1e3)/10:0})}B.sort((d,p)=>p.costUSD-d.costUSD);let _=[];for(let[d,p]of E.entries())_.push({fileName:$.basename(d),filePath:d,touchesCount:p.count,estimatedTokens:p.estimatedTokens,estimatedCostUSD:Math.round(p.costUSD*1e4)/1e4});_.sort((d,p)=>p.estimatedCostUSD-d.estimatedCostUSD);let G=this.pricingEngine.calculateValuation(S,D,R,w);return{workspacePath:e||"All Workspaces",projectName:e&&e!=="ALL"?i:"T\u1EA5t C\u1EA3 D\u1EF1 \xC1n",generatedAt:new Date().toISOString(),dateFilter:t,totalSessions:r.length,totalTurns:w,totalInputTokens:n,totalOutputTokens:c,totalThinkingTokens:g,totalTokens:R,totalCostUSD:Math.round(S*1e4)/1e4,totalCostVND:j,activeDurationSeconds:D,totalDurationSeconds:I,models:B,topFiles:_.slice(0,20),sessions:r,allProjects:l,valuation:G}}recordProjectSummary(e,t){let i=t.workspacePath||"Unknown",o=e.get(i)||{sessions:0,tokens:0,costUSD:0,lastActive:t.startTime};o.sessions++,o.tokens+=t.totalTokens,o.costUSD+=t.costUSD,new Date(t.startTime).getTime()>new Date(o.lastActive).getTime()&&(o.lastActive=t.startTime),e.set(i,o)}isWorkspaceMatch(e,t){if(!e||!t)return!1;let i=$.normalize(e).toLowerCase(),o=$.normalize(t).toLowerCase(),u=c=>c.replace(/^\/volumes\/[^\/]+\/antigravity/,"/antigravity").replace(/^\/users\/[^\/]+\/antigravity/,"/antigravity"),l=u(i),r=u(o);if(i===o||l===r||l.startsWith(r+$.sep)||r.startsWith(l+$.sep)||i.startsWith(o+$.sep)||o.startsWith(i+$.sep))return!0;let s=$.basename(i),n=$.basename(o);return!!(s&&n&&s===n)}buildEmptyReport(e,t,i){let o=this.pricingEngine.calculateValuation(0,0,0,0);return{workspacePath:e,projectName:t,generatedAt:new Date().toISOString(),dateFilter:i,totalSessions:0,totalTurns:0,totalInputTokens:0,totalOutputTokens:0,totalThinkingTokens:0,totalTokens:0,totalCostUSD:0,totalCostVND:0,activeDurationSeconds:0,totalDurationSeconds:0,models:[],topFiles:[],sessions:[],allProjects:[],valuation:o}}};var P=class{static formatNumber(e){return new Intl.NumberFormat("en-US").format(Math.round(e))}static formatDuration(e){if(e<=0)return"0s";let t=Math.floor(e/3600),i=Math.floor(e%3600/60),o=Math.floor(e%60),u=[];return t>0&&u.push(`${t}h`),i>0&&u.push(`${i}m`),(o>0||u.length===0)&&u.push(`${o}s`),u.join(" ")}static generateMarkdown(e,t){let i=t.language==="en",o=t.currency==="VND",u=(n,c)=>o?`${this.formatNumber(c)} \u20AB (${n.toFixed(4)} USD)`:`$${n.toFixed(4)} (${this.formatNumber(c)} \u20AB)`,l=(n,c)=>o?`${this.formatNumber(c)} \u20AB ($${n.toFixed(2)} USD)`:`$${n.toFixed(2)} (${this.formatNumber(c)} \u20AB)`,r=i?"en-US":"vi-VN";if(i){let n=`# \u{1F4CA} AI PROJECT VALUATION & COST REPORT
...
`,n+=`| :--- | :--- | :--- | :--- | :--- | :--- |
`;for(let c of e.sessions.slice(0,50)){let g=new Date(c.startTime).toLocaleString(r),S=c.title.replace(/\|/g,"\\|"),D=c.modelsUsed.join(", ");n+=`| ${g} | ${S} | ${D} | ${this.formatNumber(c.totalTokens)} | ${this.formatDuration(c.activeTimeSeconds)} | $${c.costUSD.toFixed(4)} |
...
`,s+=`| :--- | :--- | :--- | :--- | :--- | :--- |
`;for(let n of e.sessions.slice(0,50)){let c=new Date(n.startTime).toLocaleString(r),g=n.title.replace(/\|/g,"\\|"),S=n.modelsUsed.join(", ");s+=`| ${c} | ${g} | ${S} | ${this.formatNumber(n.totalTokens)} | ${this.formatDuration(n.activeTimeSeconds)} | $${n.costUSD.toFixed(4)} |
...
`,s}static generateHtml(e,t){let i=t.language==="en",o=t.currency==="VND",u=i?"en-US":"vi-VN",l=i?`Project AI Cost & Valuation Report - ${e.projectName}`:`B\xE1o C\xE1o \u0110\u1ECBnh Gi\xE1 D\u1EF1 \xC1n - ${e.projectName}`,r=i?"\u{1F4CA} AI Project Valuation & Cost Report":"\u{1F4CA} B\xE1o C\xE1o \u0110\u1ECBnh Gi\xE1 & Chi Ph\xED L\u1EADp Tr\xECnh AI",s=i?"Project":"D\u1EF1 \xE1n",n=i?"Generated Date":"Ng\xE0y t\u1EA1o",c=i?"\u{1F5A8}\uFE0F Print / Save as PDF":"\u{1F5A8}\uFE0F In / Xu\u1EA5t PDF",g=i?"Actual AI Token Cost":"Chi Ph\xED AI Token Th\u1EF1c T\u1EBF",S=i?"Recommended Valuation":"\u0110\u1ECBnh Gi\xE1 \u0110\u1EC1 Xu\u1EA5t (Valuation)",D=i?"Equivalent Traditional Dev":"Dev Truy\u1EC1n Th\u1ED1ng T\u01B0\u01A1ng \u0110\u01B0\u01A1ng",I=i?"Total Tokens Consumed":"T\u1ED5ng Tokens Ti\xEAu Th\u1EE5",w=i?"\u{1F916} AI Models Breakdown":"\u{1F916} Ph\xE2n B\u1ED5 Theo AI Models",C=i?"\u{1F4DD} Detailed Sessions Breakdown":"\u{1F4DD} Chi Ti\u1EBFt C\xE1c Phi\xEAn L\xE0m Vi\u1EC7c (Sessions)",E="AI Model",R=i?"Provider":"Nh\xE0 Cung C\u1EA5p",j="Input Tokens",B="Output Tokens",_="Thinking Tokens",G=i?"Cost (USD)":"Chi Ph\xED (USD)",d=i?"Cost Share":"T\u1EF7 L\u1EC7",p=i?"Timestamp":"Th\u1EDDi Gian",h=i?"Request / Task":"Y\xEAu C\u1EA7u / Prompt",x=i?"Duration":"Th\u1EDDi L\u01B0\u1EE3ng";return`<!DOCTYPE html>
<html lang="${i?"en":"vi"}">
<head>
    <meta charset="UTF-8">
...
`),n.appendMarkdown(`- **Chi ph\xED AI Token:** \`$${e.totalCostUSD.toFixed(4)}\` (~${P.formatNumber(e.totalCostVND)} \u20AB)
`),n.appendMarkdown(`- **\u0110\u1ECBnh gi\xE1 \u0111\u1EC1 xu\u1EA5t:** \`$${e.valuation.recommendedValuationUSD.toFixed(2)}\` (~${P.formatNumber(e.valuation.recommendedValuationVND)} \u20AB)
`),n.appendMarkdown(`- **T\u1ED5ng Tokens:** \`${P.formatNumber(e.totalTokens)}\` tokens
`),n.appendMarkdown(`- **Active Coding Time:** \`${s}\` (${e.totalSessions} sessions)

`),e.models.length>0){n.appendMarkdown(`**Models S\u1EED D\u1EE5ng:**
`);for(let c of e.models)n.appendMarkdown(`- **${c.displayName}:** ${c.percentageOfCost}% ($${c.costUSD.toFixed(3)})
`)}n.appendMarkdown(`
*Nh\u1EA5p \u0111\u1EC3 m\u1EDF menu qu\u1EA3n l\xFD & xu\u1EA5t b\xE1o c\xE1o.*`)}this.statusBarItem.tooltip=n}dispose(){this.statusBarItem.dispose()}};var J=A(require("vscode"));var le=class{constructor(e,t,i,o,u){this._extensionUri=e;this._currentConfig=t,this._onRefreshCallback=i,this._onExportCallback=o,this._onUpdateConfigCallback=u}_view;_currentReport=null;_currentConfig;_onRefreshCallback;_onExportCallback;_onUpdateConfigCallback;resolveWebviewView(e,t,i){this._view=e,e.webview.options={enableScripts:!0,localResourceRoots:[this._extensionUri]},e.webview.html=this._getHtmlForWebview(e.webview),e.webview.onDidReceiveMessage(async o=>{switch(o.type){case"refresh":await this._onRefreshCallback(o.workspacePath,o.dateFilter);break;case"exportReport":await this._onExportCallback(o.format||"markdown");break;case"updateConfig":await this._onUpdateConfigCallback(o.config);break;case"copySummary":{if(this._currentReport){let u=this._currentConfig.language==="en",l=this._currentConfig.currency==="VND",r=l?`${P.formatNumber(this._currentReport.totalCostVND)} \u20AB`:`$${this._currentReport.totalCostUSD.toFixed(3)}`,s=l?`${P.formatNumber(this._currentReport.valuation.recommendedValuationVND)} \u20AB`:`$${this._currentReport.valuation.recommendedValuationUSD.toFixed(2)}`,n="";u?(n=`\u{1F4CA} [Acost] Project: ${this._currentReport.projectName}
- AI Token Cost: ${r}
- Recommended Valuation: ${s}
- Total Tokens: ${P.formatNumber(this._currentReport.totalTokens)}
- Active Time: ${P.formatDuration(this._currentReport.activeDurationSeconds)} (${this._currentReport.totalSessions} sessions)`,J.window.showInformationMessage("Valuation summary copied to clipboard!")):(n=`\u{1F4CA} [Acost] D\u1EF1 \xE1n: ${this._currentReport.projectName}
- Chi ph\xED Token AI: ${r}
- \u0110\u1ECBnh gi\xE1 \u0111\u1EC1 xu\u1EA5t: ${s}
- T\u1ED5ng Tokens: ${P.formatNumber(this._currentReport.totalTokens)}
- Active Time: ${P.formatDuration(this._currentReport.activeDurationSeconds)} (${this._currentReport.totalSessions} sessions)`,J.window.showInformationMessage("\u0110\xE3 sao ch\xE9p t\xF3m t\u1EAFt \u0111\u1ECBnh gi\xE1 v\xE0o Clipboard!")),await J.env.clipboard.writeText(n)}break}case"openSettings":J.commands.executeCommand("workbench.action.openSettings","acost");break}}),this._currentReport&&this.updateReport(this._currentReport,this._currentConfig)}updateReport(e,t){this._currentReport=e,this._currentConfig=t,this._view&&this._view.webview.postMessage({type:"update",report:e,config:t,translations:ae})}_getHtmlForWebview(e){return`<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`}};var H=A(require("vscode")),fe=A(require("https"));function he(a,e){let t=a.replace(/^v/,"").split(".").map(Number),i=e.replace(/^v/,"").split(".").map(Number);for(let o=0;o<Math.max(t.length,i.length);o++){let u=t[o]||0,l=i[o]||0;if(l>u)return!0;if(l<u)return!1}return!1}var ve="trinhhaox",be="acost",je=`https://api.github.com/repos/${ve}/${be}/releases/latest`,Be=`https://api.github.com/repos/${ve}/${be}/tags`;async function ce(a,e,t=!1){try{let i=a.extension.packageJSON.version||"1.0.0",u=(e.language||"vi")==="en";fe.get(je,{headers:{"User-Agent":"Acost-Extension",Accept:"application/vnd.github.v3+json"}},r=>{let s="";r.on("data",n=>{s+=n}),r.on("end",()=>{if(r.statusCode===200)try{let n=JSON.parse(s),g=(n.tag_name||"").replace(/^v/,"");if(g&&he(i,g))Me(g,n.html_url,u);else if(t){let S=u?`Acost is up to date (v${i}).`:`Acost \u0111\xE3 l\xE0 phi\xEAn b\u1EA3n m\u1EDBi nh\u1EA5t (v${i}).`;H.window.showInformationMessage(S)}}catch{De(i,u,t)}else De(i,u,t)})}).on("error",r=>{t&&H.window.showErrorMessage(u?`Failed to check for updates: ${r.message}`:`L\u1ED7i khi ki\u1EC3m tra c\u1EADp nh\u1EADt: ${r.message}`)})}catch(i){t&&H.window.showErrorMessage(`Update check error: ${i?.message||i}`)}}function De(a,e,t){fe.get(Be,{headers:{"User-Agent":"Acost-Extension",Accept:"application/vnd.github.v3+json"}},o=>{let u="";o.on("data",l=>{u+=l}),o.on("end",()=>{if(o.statusCode===200)try{let l=JSON.parse(u);if(Array.isArray(l)&&l.length>0){let s=(l[0].name||"").replace(/^v/,"");if(s&&he(a,s)){let n=`https://github.com/${ve}/${be}/releases`;Me(s,n,e);return}}}catch{}if(t){let l=e?`Acost is up to date (v${a}).`:`Acost \u0111\xE3 l\xE0 phi\xEAn b\u1EA3n m\u1EDBi nh\u1EA5t (v${a}).`;H.window.showInformationMessage(l)}})}).on("error",()=>{})}async function Me(a,e,t){let i=t?"Download Update":"T\u1EA3i V\u1EC1 Ngay",o=t?"View Changelog":"Xem Chi Ti\u1EBFt",u=t?`\u{1F680} A new version of Acost (v${a}) is available on GitHub!`:`\u{1F680} \u0110\xE3 c\xF3 phi\xEAn b\u1EA3n m\u1EDBi c\u1EE7a Acost (v${a}) tr\xEAn GitHub!`,l=await H.window.showInformationMessage(u,i,o);(l===i||l===o)&&H.env.openExternal(H.Uri.parse(e))}var X,xe,Se,N=null,y,de=null,ue=null,pe=null,te,we="all";function $e(){let a=v.workspace.getConfiguration("acost"),e=v.workspace.getConfiguration("antigravityCost"),t=(v.env.language.startsWith("vi"),"vi");return{language:a.get("language",e.get("language",t)),currency:a.get("currency",e.get("currency","USD")),vndExchangeRate:a.get("vndExchangeRate",e.get("vndExchangeRate",25500)),markupMultiplier:a.get("markupMultiplier",e.get("markupMultiplier",2.5)),humanHourlyRate:a.get("humanHourlyRate",e.get("humanHourlyRate",25)),customPricing:a.get("customPricing",e.get("customPricing",{}))}}function Ee(){if(te&&te!=="CURRENT")return te==="ALL"?void 0:te;let a=v.workspace.workspaceFolders;if(a&&a.length>0)return a[0].uri.fsPath}async function F(a=!1,e,t){e!==void 0&&(te=e),t!==void 0&&(we=t);let i=Ee();N=await X.scanWorkspace(i,we),xe.update(N,y),Se.updateReport(N,y),a&&N&&(y.language==="en"?v.window.showInformationMessage(`Acost [${N.projectName}]: Scanned ${N.totalSessions} sessions (${P.formatNumber(N.totalTokens)} tokens, ~$${N.totalCostUSD.toFixed(3)})`):v.window.showInformationMessage(`Acost [${N.projectName}]: \u0110\xE3 qu\xE9t ${N.totalSessions} sessions (${P.formatNumber(N.totalTokens)} tokens, ~$${N.totalCostUSD.toFixed(3)})`))}async function ee(a="markdown"){let e=Z(y.language);if(!N||N.totalSessions===0){v.window.showWarningMessage(y.language==="en"?"No cost data available to export.":"Ch\u01B0a c\xF3 d\u1EEF li\u1EC7u chi ph\xED \u0111\u1EC3 xu\u1EA5t b\xE1o c\xE1o.");return}let i=Ee()||v.Uri.file(process.cwd()).fsPath,o="PROJECT_VALUATION_REPORT.md",u="";a==="html"?(o="PROJECT_VALUATION_REPORT.html",u=P.generateHtml(N,y)):a==="json"?(o="project_cost_data.json",u=P.generateJson(N)):u=P.generateMarkdown(N,y);let l=me.join(i,o);try{z.writeFileSync(l,u,"utf8");let r=e.openFile,s=e.reportExportSuccess.replace("{filename}",o);if(await v.window.showInformationMessage(s,r)===r){let c=await v.workspace.openTextDocument(v.Uri.file(l));await v.window.showTextDocument(c)}}catch(r){v.window.showErrorMessage(e.exportError.replace("{err}",r?.message||r))}}function _e(){let a=null,e=()=>{a&&clearTimeout(a),a=setTimeout(()=>{F()},1500)};try{let t=me.join(Te.homedir(),".gemini","antigravity-ide","brain");z.existsSync(t)&&(ue=z.watch(t,{recursive:!0},(i,o)=>{o&&o.endsWith("transcript.jsonl")&&e()}))}catch{}try{let t=me.join(Te.homedir(),".claude","projects");z.existsSync(t)&&(pe=z.watch(t,{recursive:!0},(i,o)=>{o&&o.endsWith(".jsonl")&&e()}))}catch{}}function Oe(a){y=$e(),X=new se(y),xe=new re,Se=new le(a.extensionUri,y,async(t,i)=>{await F(!0,t,i)},async t=>{await ee(t)},async t=>{y={...y,...t},X.updateConfig(y),N&&await F()}),a.subscriptions.push(v.window.registerWebviewViewProvider("acost.sidebar",Se)),a.subscriptions.push(xe),a.subscriptions.push(v.commands.registerCommand("acost.refresh",async()=>{await F(!0)})),a.subscriptions.push(v.commands.registerCommand("acost.exportReport",async()=>{await ee("markdown")})),a.subscriptions.push(v.commands.registerCommand("acost.exportHtmlReport",async()=>{await ee("html")})),a.subscriptions.push(v.commands.registerCommand("acost.openDashboard",()=>{v.commands.executeCommand("acost.sidebar.focus")})),a.subscriptions.push(v.commands.registerCommand("acost.checkUpdate",async()=>{await ce(a,y,!0)})),a.subscriptions.push(v.commands.registerCommand("acost.menu",async()=>{let t=Z(y.language),i=[{id:"dashboard",label:t.menuOpenDashboard,description:t.menuOpenDashboardDesc},{id:"refresh",label:t.menuRefresh,description:t.menuRefreshDesc},{id:"export_md",label:t.menuExportMd,description:t.menuExportMdDesc},{id:"export_html",label:t.menuExportHtml,description:t.menuExportHtmlDesc},{id:"check_update",label:t.menuCheckUpdate,description:t.menuCheckUpdateDesc},{id:"toggle_currency",label:t.menuToggleCurrency,description:`Current: ${y.currency}`},{id:"toggle_language",label:t.menuToggleLanguage,description:`Current: ${y.language==="en"?"\u{1F1EC}\u{1F1E7} English":"\u{1F1FB}\u{1F1F3} Ti\u1EBFng Vi\u1EC7t"}`},{id:"settings",label:t.menuSettings,description:t.menuSettingsDesc}],o=await v.window.showQuickPick(i,{placeHolder:`Acost - AI Cost & Valuation (${y.language.toUpperCase()})`});if(o)switch(o.id){case"dashboard":v.commands.executeCommand("acost.sidebar.focus");break;case"refresh":await F(!0);break;case"export_md":await ee("markdown");break;case"export_html":await ee("html");break;case"check_update":await ce(a,y,!0);break;case"toggle_currency":{let u=y.currency==="USD"?"VND":"USD";y.currency=u,X.updateConfig(y),await F(),v.window.showInformationMessage(y.language==="en"?`Switched currency to: ${u}`:`\u0110\xE3 \u0111\u1ED5i \u0111\u01A1n v\u1ECB ti\u1EC1n t\u1EC7 sang: ${u}`);break}case"toggle_language":{let u=y.language==="vi"?"en":"vi";y.language=u,X.updateConfig(y),await F(),v.window.showInformationMessage(u==="en"?"Switched language to English \u{1F1EC}\u{1F1E7}":"\u0110\xE3 \u0111\u1ED5i ng\xF4n ng\u1EEF sang Ti\u1EBFng Vi\u1EC7t \u{1F1FB}\u{1F1F3}");break}case"settings":v.commands.executeCommand("workbench.action.openSettings","acost");break}})),a.subscriptions.push(v.workspace.onDidChangeConfiguration(async t=>{(t.affectsConfiguration("acost")||t.affectsConfiguration("antigravityCost"))&&(y=$e(),X.updateConfig(y),await F())})),a.subscriptions.push(v.workspace.onDidChangeWorkspaceFolders(async()=>{await F()})),_e(),setTimeout(()=>{F()},1e3),v.workspace.getConfiguration("acost").get("autoCheckUpdates",v.workspace.getConfiguration("antigravityCost").get("autoCheckUpdates",!0))&&setTimeout(()=>{ce(a,y,!1)},3e3),de=setInterval(()=>{F()},6e4)}function He(){de&&(clearInterval(de),de=null),ue&&(ue.close(),ue=null),pe&&(pe.close(),pe=null)}0&&(module.exports={activate,deactivate});
