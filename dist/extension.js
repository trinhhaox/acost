"use strict";var Dt=Object.create;var tt=Object.defineProperty;var wt=Object.getOwnPropertyDescriptor;var Mt=Object.getOwnPropertyNames;var $t=Object.getPrototypeOf,Et=Object.prototype.hasOwnProperty;var Nt=(a,t)=>{for(var e in t)tt(a,e,{get:t[e],enumerable:!0})},vt=(a,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of Mt(t))!Et.call(a,r)&&r!==e&&tt(a,r,{get:()=>t[r],enumerable:!(i=wt(t,r))||i.enumerable});return a};var D=(a,t,e)=>(e=a!=null?Dt($t(a)):{},vt(t||!a||!a.__esModule?tt(e,"default",{value:a,enumerable:!0}):e,a)),It=a=>vt(tt({},"__esModule",{value:!0}),a);var Bt={};Nt(Bt,{activate:()=>Vt,deactivate:()=>Ft});module.exports=It(Bt);var f=D(require("vscode")),z=D(require("fs")),ht=D(require("path")),kt=D(require("os"));var H=D(require("fs")),A=D(require("path")),Tt=D(require("os"));var At={"gemini-3.7-flash":{displayName:"Gemini 3.7 Flash",provider:"Google",inputPricePerMillion:.15,outputPricePerMillion:.6,cacheReadPricePerMillion:.0375},"gemini-3.6-flash":{displayName:"Gemini 3.6 Flash",provider:"Google",inputPricePerMillion:.15,outputPricePerMillion:.6,cacheReadPricePerMillion:.0375},"gemini-3.5-flash":{displayName:"Gemini 3.5 Flash",provider:"Google",inputPricePerMillion:.1,outputPricePerMillion:.4,cacheReadPricePerMillion:.025},"gemini-3.1-pro":{displayName:"Gemini 3.1 Pro",provider:"Google",inputPricePerMillion:1.25,outputPricePerMillion:5,cacheReadPricePerMillion:.3125},"gemini-2.5-pro":{displayName:"Gemini 2.5 Pro",provider:"Google",inputPricePerMillion:1.25,outputPricePerMillion:5,cacheReadPricePerMillion:.3125},"gemini-2.5-flash":{displayName:"Gemini 2.5 Flash",provider:"Google",inputPricePerMillion:.075,outputPricePerMillion:.3,cacheReadPricePerMillion:.01875},"gemini-1.5-pro":{displayName:"Gemini 1.5 Pro",provider:"Google",inputPricePerMillion:1.25,outputPricePerMillion:5,cacheReadPricePerMillion:.3125},"gemini-1.5-flash":{displayName:"Gemini 1.5 Flash",provider:"Google",inputPricePerMillion:.075,outputPricePerMillion:.3,cacheReadPricePerMillion:.01875},"claude-sonnet-4.6":{displayName:"Claude Sonnet 4.6 (Thinking)",provider:"Anthropic",inputPricePerMillion:3,outputPricePerMillion:15,cacheReadPricePerMillion:.3},"claude-opus-4.6":{displayName:"Claude Opus 4.6 (Thinking)",provider:"Anthropic",inputPricePerMillion:15,outputPricePerMillion:75,cacheReadPricePerMillion:1.5},"claude-3.7-sonnet":{displayName:"Claude 3.7 Sonnet",provider:"Anthropic",inputPricePerMillion:3,outputPricePerMillion:15,cacheReadPricePerMillion:.3},"claude-3.5-sonnet":{displayName:"Claude 3.5 Sonnet",provider:"Anthropic",inputPricePerMillion:3,outputPricePerMillion:15,cacheReadPricePerMillion:.3},"claude-3.5-haiku":{displayName:"Claude 3.5 Haiku",provider:"Anthropic",inputPricePerMillion:.8,outputPricePerMillion:4,cacheReadPricePerMillion:.08},"claude-3-opus":{displayName:"Claude 3 Opus",provider:"Anthropic",inputPricePerMillion:15,outputPricePerMillion:75,cacheReadPricePerMillion:1.5},"gpt-4o":{displayName:"GPT-4o",provider:"OpenAI",inputPricePerMillion:2.5,outputPricePerMillion:10,cacheReadPricePerMillion:1.25},"gpt-4o-mini":{displayName:"GPT-4o mini",provider:"OpenAI",inputPricePerMillion:.15,outputPricePerMillion:.6,cacheReadPricePerMillion:.075},"o3-mini":{displayName:"o3-mini",provider:"OpenAI",inputPricePerMillion:1.1,outputPricePerMillion:4.4,cacheReadPricePerMillion:.55},o1:{displayName:"o1",provider:"OpenAI",inputPricePerMillion:15,outputPricePerMillion:60,cacheReadPricePerMillion:7.5},default:{displayName:"Standard AI Model",provider:"Other",inputPricePerMillion:.5,outputPricePerMillion:1.5,cacheReadPricePerMillion:.1}},X=class{pricingTable;config;constructor(t){if(this.config=t,this.pricingTable={...At},t.customPricing)for(let[e,i]of Object.entries(t.customPricing))this.pricingTable[e]?this.pricingTable[e]={...this.pricingTable[e],...i}:i.inputPricePerMillion!==void 0&&i.outputPricePerMillion!==void 0&&(this.pricingTable[e]={displayName:i.displayName||e,provider:i.provider||"Other",inputPricePerMillion:i.inputPricePerMillion,outputPricePerMillion:i.outputPricePerMillion,cacheReadPricePerMillion:i.cacheReadPricePerMillion||0})}normalizeModelKey(t){if(!t)return"gemini-3.7-flash";let e=t.toLowerCase();return e.includes("3.7")&&e.includes("flash")?"gemini-3.7-flash":e.includes("3.6")&&e.includes("flash")?"gemini-3.6-flash":e.includes("3.5")&&e.includes("flash")?"gemini-3.5-flash":e.includes("3.1")&&e.includes("pro")?"gemini-3.1-pro":e.includes("2.5")&&e.includes("pro")?"gemini-2.5-pro":e.includes("2.5")&&e.includes("flash")?"gemini-2.5-flash":e.includes("1.5")&&e.includes("pro")?"gemini-1.5-pro":e.includes("1.5")&&e.includes("flash")?"gemini-1.5-flash":e.includes("claude")&&e.includes("sonnet")&&e.includes("4.6")?"claude-sonnet-4.6":e.includes("claude")&&e.includes("opus")&&e.includes("4.6")?"claude-opus-4.6":e.includes("claude")&&e.includes("3.7")&&e.includes("sonnet")?"claude-3.7-sonnet":e.includes("claude")&&e.includes("3.5")&&e.includes("sonnet")?"claude-3.5-sonnet":e.includes("claude")&&e.includes("haiku")?"claude-3.5-haiku":e.includes("claude")&&e.includes("opus")?"claude-3-opus":e.includes("gpt-4o-mini")||e.includes("4o-mini")?"gpt-4o-mini":e.includes("gpt-4o")||e.includes("4o")?"gpt-4o":e.includes("o3-mini")?"o3-mini":e.includes("o1")?"o1":e.includes("gemini")?"gemini-3.7-flash":e.includes("claude")?"claude-sonnet-4.6":e.includes("gpt")?"gpt-4o":"default"}getModelPricing(t){let e=this.normalizeModelKey(t);return this.pricingTable[e]||this.pricingTable.default}calculateCostUSD(t,e,i,r=0){let c=this.getModelPricing(t),u=i+r,m=e/1e6*c.inputPricePerMillion,o=u/1e6*c.outputPricePerMillion;return m+o}usdToVnd(t){return Math.round(t*this.config.vndExchangeRate)}calculateValuation(t,e,i,r){let c=this.usdToVnd(t),u=e/3600,m=Math.max(1,Math.round((u*4.5+i/5e4*1.5)*10)/10),o=this.config.humanHourlyRate,n=Math.round(m*o),d=this.usdToVnd(n),p=o*.6,y=u*p,C=Math.round((t*this.config.markupMultiplier+y+r*.5)*100)/100,$=this.usdToVnd(C),k=Math.max(0,n-C),P=this.usdToVnd(k);return{apiCostUSD:Math.round(t*1e4)/1e4,apiCostVND:c,humanHoursEquivalent:m,humanHourlyRate:o,humanCostEquivalentUSD:n,humanCostEquivalentVND:d,markupMultiplier:this.config.markupMultiplier,recommendedValuationUSD:C,recommendedValuationVND:$,savingsUSD:k,savingsVND:P}}};var et=D(require("fs")),F=D(require("path")),bt=D(require("readline"));var I=class{static estimateTokens(t){if(!t||t.length===0)return 0;let e=t.length;if(e<4)return 1;let i=0,r=0,c=0;for(let d=0;d<Math.min(e,2e3);d++){let p=t.charCodeAt(d);p>255?i++:p===32||p===10||p===9||p===13?c++:(p>=33&&p<=47||p>=58&&p<=64||p>=91&&p<=96||p>=123&&p<=126)&&r++}let u=Math.min(e,2e3),m=i/u,o=r/u,n=3.8;return m>.15?n=2.6:o>.25&&(n=3.3),Math.ceil(e/n)}static estimateObjectTokens(t){if(!t)return 0;try{let e=typeof t=="string"?t:JSON.stringify(t);return this.estimateTokens(e)}catch{return 0}}};var K=class{pricingEngine;constructor(t){this.pricingEngine=t}async parseFile(t,e){if(!et.existsSync(t))return null;let i=F.basename(F.dirname(F.dirname(t))),r=et.createReadStream(t,{encoding:"utf8"}),c=bt.createInterface({input:r,crlfDelay:1/0}),u="",m="",o="gemini-3.7-flash",n=new Set,d=new Set,p=0,y=0,C=0,$=0,k=null,P=null,E=0,U=null;for await(let l of c)if(l.trim())try{let s=JSON.parse(l),g=s.type||"",v=s.source||"",h=s.content||"",J=s.created_at,B=null;if(J){let x=new Date(J).getTime();if(!isNaN(x)){if(B=x,(k===null||x<k)&&(k=x),(P===null||x>P)&&(P=x),U!==null){let w=(x-U)/1e3;w>0&&w<300&&(E+=w)}U=x}}if(h.includes("Model Selection")||h.includes("USER_SETTINGS_CHANGE")){let x=h.match(/Model Selection` from [^\n]+? to (.+?)\.\s*No need/i)||h.match(/Model Selection` from [^\n]+? to ([^\.\n<]+)/i)||h.match(/setting `Model Selection` from [^\n]+? to ([^\n<]+)/i);if(x&&x[1]){let w=x[1].trim();o=this.pricingEngine.normalizeModelKey(w),n.add(o)}}if(!u){let x=h.match(/\[URI\] -> \[CorpusName\]:\s*([^\s\n]+)/);if(x&&x[1])u=x[1].trim();else{let w=h.match(/Active Document:\s*([^\n\r]+)/);if(w&&w[1]){let N=w[1].trim();u=F.dirname(N)}else{let N=h.match(/@\[([^\]]+)\]/);if(N&&N[1]){let ft=N[1].trim();ft.startsWith("/")&&(u=ft)}}}}if(g==="USER_INPUT"&&!m){let x=h.match(/<USER_REQUEST>([\s\S]*?)<\/USER_REQUEST>/);x&&x[1]?m=x[1].trim().replace(/\n+/g," ").slice(0,80):m=h.replace(/<[^>]+>/g,"").trim().slice(0,80)}if(g==="USER_INPUT")$++,p+=I.estimateTokens(h);else if(g==="KNOWLEDGE_ARTIFACTS"||g==="CONVERSATION_HISTORY"||g==="SYSTEM_MESSAGE"||g==="VIEW_FILE"||g==="GREP_SEARCH"||g==="LIST_DIRECTORY"||g==="RUN_COMMAND"||g==="READ_URL_CONTENT"||g==="MCP_TOOL")p+=I.estimateTokens(h);else if(g==="PLANNER_RESPONSE"){if(s.thinking&&(C+=I.estimateTokens(s.thinking)),h&&(y+=I.estimateTokens(h)),s.tool_calls&&Array.isArray(s.tool_calls))for(let x of s.tool_calls){y+=I.estimateObjectTokens(x);let w=x.args||{},N=w.AbsolutePath||w.TargetFile||w.DirectoryPath;N&&typeof N=="string"&&N.startsWith("/")&&d.add(N.replace(/^"|"$/g,""))}}else v==="MODEL"?y+=I.estimateTokens(h):p+=I.estimateTokens(h)}catch{}if(n.size===0&&n.add(o),e&&u){let l=F.normalize(e).toLowerCase(),s=F.normalize(u).toLowerCase();if(!(s.startsWith(l)||l.startsWith(s)))return null}let L=k&&P?Math.max(1,Math.round((P-k)/1e3)):Math.max(1,Math.round(E)),W=Math.min(L,Math.max(15,Math.round(E))),j=Array.from(n)[0]||"gemini-3.7-flash",V=this.pricingEngine.calculateCostUSD(j,p,y,C),q=this.pricingEngine.usdToVnd(V);return{sessionId:i,workspacePath:u||e||"Unknown Workspace",title:m||`Session ${i.slice(0,8)}`,startTime:k?new Date(k).toISOString():new Date().toISOString(),endTime:P?new Date(P).toISOString():new Date().toISOString(),durationSeconds:L,activeTimeSeconds:W,modelsUsed:Array.from(n),turnsCount:Math.max(1,$),inputTokens:p,outputTokens:y,thinkingTokens:C,totalTokens:p+y+C,costUSD:Math.round(V*1e4)/1e4,costVND:q,filesTouched:Array.from(d),filePath:t}}};var nt=class{pricingEngine;parser;brainDir;cache=new Map;constructor(t,e){this.pricingEngine=new X(t),this.parser=new K(this.pricingEngine),this.brainDir=e||A.join(Tt.homedir(),".gemini","antigravity-ide","brain")}updateConfig(t){this.pricingEngine=new X(t),this.parser=new K(this.pricingEngine),this.cache.clear()}async scanWorkspace(t,e="all"){let i=t?A.basename(t):"All Projects",r=[],c=new Map;if(!H.existsSync(this.brainDir))return this.buildEmptyReport(t||"",i,e);let u=[];try{u=H.readdirSync(this.brainDir)}catch{return this.buildEmptyReport(t||"",i,e)}for(let l of u){let s=A.join(this.brainDir,l,".system_generated","logs","transcript.jsonl");if(H.existsSync(s))try{let g=H.statSync(s),v=this.cache.get(s),h=null;if(v&&v.mtime===g.mtimeMs?h=v.data:(h=await this.parser.parseFile(s),this.cache.set(s,{mtime:g.mtimeMs,data:h})),h){r.push(h);let J=h.workspacePath||"Unknown",B=c.get(J)||{sessions:0,tokens:0,costUSD:0,lastActive:h.startTime};B.sessions++,B.tokens+=h.totalTokens,B.costUSD+=h.costUSD,new Date(h.startTime).getTime()>new Date(B.lastActive).getTime()&&(B.lastActive=h.startTime),c.set(J,B)}}catch{}}let m=[];for(let[l,s]of c.entries())m.push({workspacePath:l,projectName:l==="Unknown"?"Unknown Project":A.basename(l),totalSessions:s.sessions,totalTokens:s.tokens,totalCostUSD:Math.round(s.costUSD*1e4)/1e4,totalCostVND:this.pricingEngine.usdToVnd(s.costUSD),lastActive:s.lastActive});m.sort((l,s)=>s.totalCostUSD-l.totalCostUSD);let o=r;if(t&&t!=="ALL"&&t!=="All Projects"){let l=A.normalize(t).toLowerCase();o=r.filter(s=>{let g=A.normalize(s.workspacePath).toLowerCase();return g.startsWith(l)||l.startsWith(g)})}let n=Date.now();if(e==="today"){let l=new Date;l.setHours(0,0,0,0);let s=l.getTime();o=o.filter(g=>new Date(g.startTime).getTime()>=s)}else if(e==="7d"){let l=n-6048e5;o=o.filter(s=>new Date(s.startTime).getTime()>=l)}else if(e==="30d"){let l=n-2592e6;o=o.filter(s=>new Date(s.startTime).getTime()>=l)}o.sort((l,s)=>new Date(s.startTime).getTime()-new Date(l.startTime).getTime());let d=0,p=0,y=0,C=0,$=0,k=0,P=0,E=new Map,U=new Map;for(let l of o){d+=l.inputTokens,p+=l.outputTokens,y+=l.thinkingTokens,C+=l.costUSD,$+=l.activeTimeSeconds,k+=l.durationSeconds,P+=l.turnsCount;for(let s of l.modelsUsed){let g=E.get(s)||{input:0,output:0,thinking:0,costUSD:0},v=1/l.modelsUsed.length;g.input+=Math.round(l.inputTokens*v),g.output+=Math.round(l.outputTokens*v),g.thinking+=Math.round(l.thinkingTokens*v),g.costUSD+=l.costUSD*v,E.set(s,g)}if(l.filesTouched&&l.filesTouched.length>0){let s=Math.round(l.totalTokens/l.filesTouched.length),g=l.costUSD/l.filesTouched.length;for(let v of l.filesTouched){let h=U.get(v)||{count:0,estimatedTokens:0,costUSD:0};h.count++,h.estimatedTokens+=s,h.costUSD+=g,U.set(v,h)}}}let L=d+p+y,W=this.pricingEngine.usdToVnd(C),j=[];for(let[l,s]of E.entries()){let g=this.pricingEngine.getModelPricing(l),v=s.input+s.output+s.thinking;j.push({modelName:l,displayName:g.displayName||l,provider:g.provider||"Other",inputTokens:s.input,outputTokens:s.output,thinkingTokens:s.thinking,totalTokens:v,costUSD:Math.round(s.costUSD*1e4)/1e4,costVND:this.pricingEngine.usdToVnd(s.costUSD),percentageOfCost:C>0?Math.round(s.costUSD/C*1e3)/10:0,percentageOfTokens:L>0?Math.round(v/L*1e3)/10:0})}j.sort((l,s)=>s.costUSD-l.costUSD);let V=[];for(let[l,s]of U.entries())V.push({fileName:A.basename(l),filePath:l,touchesCount:s.count,estimatedTokens:s.estimatedTokens,estimatedCostUSD:Math.round(s.costUSD*1e4)/1e4});V.sort((l,s)=>s.estimatedCostUSD-l.estimatedCostUSD);let q=this.pricingEngine.calculateValuation(C,$,L,P);return{workspacePath:t||"All Workspaces",projectName:t&&t!=="ALL"?i:"T\u1EA5t C\u1EA3 D\u1EF1 \xC1n",generatedAt:new Date().toISOString(),dateFilter:e,totalSessions:o.length,totalTurns:P,totalInputTokens:d,totalOutputTokens:p,totalThinkingTokens:y,totalTokens:L,totalCostUSD:Math.round(C*1e4)/1e4,totalCostVND:W,activeDurationSeconds:$,totalDurationSeconds:k,models:j,topFiles:V.slice(0,20),sessions:o,allProjects:m,valuation:q}}buildEmptyReport(t,e,i){let r=this.pricingEngine.calculateValuation(0,0,0,0);return{workspacePath:t,projectName:e,generatedAt:new Date().toISOString(),dateFilter:i,totalSessions:0,totalTurns:0,totalInputTokens:0,totalOutputTokens:0,totalThinkingTokens:0,totalTokens:0,totalCostUSD:0,totalCostVND:0,activeDurationSeconds:0,totalDurationSeconds:0,models:[],topFiles:[],sessions:[],allProjects:[],valuation:r}}};var T=class{static formatNumber(t){return new Intl.NumberFormat("en-US").format(Math.round(t))}static formatDuration(t){if(t<=0)return"0s";let e=Math.floor(t/3600),i=Math.floor(t%3600/60),r=Math.floor(t%60),c=[];return e>0&&c.push(`${e}h`),i>0&&c.push(`${i}m`),(r>0||c.length===0)&&c.push(`${r}s`),c.join(" ")}static generateMarkdown(t,e){let i=e.language==="en",r=e.currency==="VND",c=(n,d)=>r?`${this.formatNumber(d)} \u20AB (${n.toFixed(4)} USD)`:`$${n.toFixed(4)} (${this.formatNumber(d)} \u20AB)`,u=(n,d)=>r?`${this.formatNumber(d)} \u20AB ($${n.toFixed(2)} USD)`:`$${n.toFixed(2)} (${this.formatNumber(d)} \u20AB)`,m=i?"en-US":"vi-VN";if(i){let n=`# \u{1F4CA} AI PROJECT VALUATION & COST REPORT

`;n+=`> **Project:** \`${t.projectName}\`  
`,n+=`> **Workspace:** \`${t.workspacePath}\`  
`,n+=`> **Generated Date:** \`${new Date(t.generatedAt).toLocaleString(m)}\`  
...
`,n+=`| :--- | :--- | :--- |
`,n+=`| **Total Actual AI API Cost** | **${c(t.totalCostUSD,t.totalCostVND)}** | Raw token cost paid to AI model providers |
`,n+=`| **Recommended Project Valuation** | **${u(t.valuation.recommendedValuationUSD,t.valuation.recommendedValuationVND)}** | Applied **x${t.valuation.markupMultiplier}** Markup + AI Prompt Engineering Operator Cost |
`,n+=`| **Equivalent Traditional Dev Cost** | **${u(t.valuation.humanCostEquivalentUSD,t.valuation.humanCostEquivalentVND)}** | Estimated ${t.valuation.humanHoursEquivalent} hrs @ $${t.valuation.humanHourlyRate}/hr |
`,n+=`| **Budget Savings vs Traditional Dev** | **${u(t.valuation.savingsUSD,t.valuation.savingsVND)}** | Saved ~${t.valuation.humanCostEquivalentUSD>0?Math.round(t.valuation.savingsUSD/t.valuation.humanCostEquivalentUSD*100):0}% engineering budget |
...
`,n+=`| :--- | :--- | :--- | :--- | :--- | :--- |
`;for(let d of t.sessions.slice(0,50)){let p=new Date(d.startTime).toLocaleString(m),y=d.title.replace(/\|/g,"\\|"),C=d.modelsUsed.join(", ");n+=`| ${p} | ${y} | ${C} | ${this.formatNumber(d.totalTokens)} | ${this.formatDuration(d.activeTimeSeconds)} | $${d.costUSD.toFixed(4)} |
...
`,o+=`> **Th\u1EDDi gian xu\u1EA5t b\xE1o c\xE1o:** \`${new Date(t.generatedAt).toLocaleString(m)}\`  
...
`,o+=`| :--- | :--- | :--- |
`,o+=`| **T\u1ED5ng Chi Ph\xED AI API Th\u1EF1c T\u1EBF** | **${c(t.totalCostUSD,t.totalCostVND)}** | Chi ph\xED token tr\u1EA3 cho nh\xE0 cung c\u1EA5p AI |
`,o+=`| **\u0110\u1ECBnh Gi\xE1 Ho\xE0n Th\xE0nh \u0110\u1EC1 Xu\u1EA5t** | **${u(t.valuation.recommendedValuationUSD,t.valuation.recommendedValuationVND)}** | \xC1p d\u1EE5ng h\u1EC7 s\u1ED1 Markup **x${t.valuation.markupMultiplier}** + C\xF4ng v\u1EADn h\xE0nh AI |
`,o+=`| **Chi Ph\xED Dev Truy\u1EC1n Th\u1ED1ng T\u01B0\u01A1ng \u0110\u01B0\u01A1ng** | **${u(t.valuation.humanCostEquivalentUSD,t.valuation.humanCostEquivalentVND)}** | \u01AF\u1EDBc t\xEDnh ${t.valuation.humanHoursEquivalent}h @ $${t.valuation.humanHourlyRate}/h |
`,o+=`| **Ti\u1EBFt Ki\u1EC7m So V\u1EDBi Dev Truy\u1EC1n Th\u1ED1ng** | **${u(t.valuation.savingsUSD,t.valuation.savingsVND)}** | Ti\u1EBFt ki\u1EC7m ~${t.valuation.humanCostEquivalentUSD>0?Math.round(t.valuation.savingsUSD/t.valuation.humanCostEquivalentUSD*100):0}% ng\xE2n s\xE1ch |
...
`,o+=`| :--- | :--- | :--- | :--- | :--- | :--- |
`;for(let n of t.sessions.slice(0,50)){let d=new Date(n.startTime).toLocaleString(m),p=n.title.replace(/\|/g,"\\|"),y=n.modelsUsed.join(", ");o+=`| ${d} | ${p} | ${y} | ${this.formatNumber(n.totalTokens)} | ${this.formatDuration(n.activeTimeSeconds)} | $${n.costUSD.toFixed(4)} |
...
`,o}static generateHtml(t,e){let i=e.language==="en",r=e.currency==="VND",c=i?"en-US":"vi-VN",u=i?`Project AI Cost & Valuation Report - ${t.projectName}`:`B\xE1o C\xE1o \u0110\u1ECBnh Gi\xE1 D\u1EF1 \xC1n - ${t.projectName}`,m=i?"\u{1F4CA} AI Project Valuation & Cost Report":"\u{1F4CA} B\xE1o C\xE1o \u0110\u1ECBnh Gi\xE1 & Chi Ph\xED L\u1EADp Tr\xECnh AI",o=i?"Project":"D\u1EF1 \xE1n",n=i?"Generated Date":"Ng\xE0y t\u1EA1o",d=i?"\u{1F5A8}\uFE0F Print / Save as PDF":"\u{1F5A8}\uFE0F In / Xu\u1EA5t PDF",p=i?"Actual AI Token Cost":"Chi Ph\xED AI Token Th\u1EF1c T\u1EBF",y=i?"Recommended Valuation":"\u0110\u1ECBnh Gi\xE1 \u0110\u1EC1 Xu\u1EA5t (Valuation)",C=i?"Equivalent Traditional Dev":"Dev Truy\u1EC1n Th\u1ED1ng T\u01B0\u01A1ng \u0110\u01B0\u01A1ng",$=i?"Total Tokens Consumed":"T\u1ED5ng Tokens Ti\xEAu Th\u1EE5",k=i?"\u{1F916} AI Models Breakdown":"\u{1F916} Ph\xE2n B\u1ED5 Theo AI Models",P=i?"\u{1F4DD} Detailed Sessions Breakdown":"\u{1F4DD} Chi Ti\u1EBFt C\xE1c Phi\xEAn L\xE0m Vi\u1EC7c (Sessions)",E="AI Model",U=i?"Provider":"Nh\xE0 Cung C\u1EA5p",L="Input Tokens",W="Output Tokens",j="Thinking Tokens",V=i?"Cost (USD)":"Chi Ph\xED (USD)",q=i?"Cost Share":"T\u1EF7 L\u1EC7",l=i?"Timestamp":"Th\u1EDDi Gian",s=i?"Request / Task":"Y\xEAu C\u1EA7u / Prompt",g=i?"Duration":"Th\u1EDDi L\u01B0\u1EE3ng";return`<!DOCTYPE html>
<html lang="${i?"en":"vi"}">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="meta">
                ...
                ${n}: ${new Date(t.generatedAt).toLocaleString(c)}
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge ${v.provider.toLowerCase()}">${v.provider}</span></td>
                    <td>${this.formatNumber(v.inputTokens)}</td>
                    <td>${this.formatNumber(v.outputTokens)}</td>
                    <td>${this.formatNumber(v.thinkingTokens)}</td>
                    <td>$${v.costUSD.toFixed(4)}</td>
                    <td><strong>${v.percentageOfCost}%</strong></td>
                </tr>
                `).join("")}
            </tbody>
        </table>
        ...
        <table>
            ...
            <tbody>
                ${t.sessions.slice(0,100).map(v=>`
                <tr>
                    <td>${new Date(v.startTime).toLocaleString(c)}</td>
                    <td>${v.title}</td>
                    <td>${v.modelsUsed.join(", ")}</td>
                    <td>${this.formatNumber(v.totalTokens)}</td>
                    <td>${this.formatDuration(v.activeTimeSeconds)}</td>
                    <td>$${v.costUSD.toFixed(4)}</td>
                </tr>
                `).join("")}
            </tbody>
...
`);for(let d of t.models)n.appendMarkdown(`- **${d.displayName}:** ${d.percentageOfCost}% ($${d.costUSD.toFixed(3)})
`)}n.appendMarkdown(`
*Nh\u1EA5p \u0111\u1EC3 m\u1EDF menu qu\u1EA3n l\xFD & xu\u1EA5t b\xE1o c\xE1o.*`)}this.statusBarItem.tooltip=n}dispose(){this.statusBarItem.dispose()}};var _=D(require("vscode"));var at=class{constructor(t,e,i,r,c){this._extensionUri=t;this._currentConfig=e,this._onRefreshCallback=i,this._onExportCallback=r,this._onUpdateConfigCallback=c}_view;_currentReport=null;_currentConfig;_onRefreshCallback;_onExportCallback;_onUpdateConfigCallback;resolveWebviewView(t,e,i){this._view=t,t.webview.options={enableScripts:!0,localResourceRoots:[this._extensionUri]},t.webview.html=this._getHtmlForWebview(t.webview),t.webview.onDidReceiveMessage(async r=>{switch(r.type){case"refresh":await this._onRefreshCallback(r.workspacePath,r.dateFilter);break;case"exportReport":await this._onExportCallback(r.format||"markdown");break;case"updateConfig":await this._onUpdateConfigCallback(r.config);break;case"copySummary":{if(this._currentReport){let c=this._currentConfig.language==="en",u=this._currentConfig.currency==="VND",m=u?`${T.formatNumber(this._currentReport.totalCostVND)} \u20AB`:`$${this._currentReport.totalCostUSD.toFixed(3)}`,o=u?`${T.formatNumber(this._currentReport.valuation.recommendedValuationVND)} \u20AB`:`$${this._currentReport.valuation.recommendedValuationUSD.toFixed(2)}`,n="";c?(n=`\u{1F4CA} [Antigravity AI Cost] Project: ${this._currentReport.projectName}
- AI Token Cost: ${m}
- Recommended Valuation: ${o}
- Total Tokens: ${T.formatNumber(this._currentReport.totalTokens)}
- Active Time: ${T.formatDuration(this._currentReport.activeDurationSeconds)} (${this._currentReport.totalSessions} sessions)`,_.window.showInformationMessage("Valuation summary copied to clipboard!")):(n=`\u{1F4CA} [Antigravity AI Cost] D\u1EF1 \xE1n: ${this._currentReport.projectName}
- Chi ph\xED Token AI: ${m}
- \u0110\u1ECBnh gi\xE1 \u0111\u1EC1 xu\u1EA5t: ${o}
- T\u1ED5ng Tokens: ${T.formatNumber(this._currentReport.totalTokens)}
- Active Time: ${T.formatDuration(this._currentReport.activeDurationSeconds)} (${this._currentReport.totalSessions} sessions)`,_.window.showInformationMessage("\u0110\xE3 sao ch\xE9p t\xF3m t\u1EAFt \u0111\u1ECBnh gi\xE1 v\xE0o Clipboard!")),await _.env.clipboard.writeText(n)}break}case"openSettings":_.commands.executeCommand("workbench.action.openSettings","antigravityCost");break}}),this._currentReport&&this.updateReport(this._currentReport,this._currentConfig)}updateReport(t,e){this._currentReport=t,this._currentConfig=e,this._view&&this._view.webview.postMessage({type:"update",report:t,config:e,translations:it})}_getHtmlForWebview(t){return`<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`}};var R=D(require("vscode")),dt=D(require("https"));function ct(a,t){let e=a.replace(/^v/,"").split(".").map(Number),i=t.replace(/^v/,"").split(".").map(Number);for(let r=0;r<Math.max(e.length,i.length);r++){let c=e[r]||0,u=i[r]||0;if(u>c)return!0;if(u<c)return!1}return!1}var ut="trinhhaox",mt="antigravity-cost",Rt=`https://api.github.com/repos/${ut}/${mt}/releases/latest`,Ut=`https://api.github.com/repos/${ut}/${mt}/tags`;async function st(a,t,e=!1){try{let i=a.extension.packageJSON.version||"1.0.0",c=(t.language||"vi")==="en";dt.get(Rt,{headers:{"User-Agent":"Antigravity-AI-Cost-Extension",Accept:"application/vnd.github.v3+json"}},m=>{let o="";m.on("data",n=>{o+=n}),m.on("end",()=>{if(m.statusCode===200)try{let n=JSON.parse(o),p=(n.tag_name||"").replace(/^v/,"");if(p&&ct(i,p))yt(p,n.html_url,c);else if(e){let y=c?`Antigravity AI Cost is up to date (v${i}).`:`Antigravity AI Cost \u0111\xE3 l\xE0 phi\xEAn b\u1EA3n m\u1EDBi nh\u1EA5t (v${i}).`;R.window.showInformationMessage(y)}}catch{xt(i,c,e)}else xt(i,c,e)})}).on("error",m=>{e&&R.window.showErrorMessage(c?`Failed to check for updates: ${m.message}`:`L\u1ED7i khi ki\u1EC3m tra c\u1EADp nh\u1EADt: ${m.message}`)})}catch(i){e&&R.window.showErrorMessage(`Update check error: ${i?.message||i}`)}}function xt(a,t,e){dt.get(Ut,{headers:{"User-Agent":"Antigravity-AI-Cost-Extension",Accept:"application/vnd.github.v3+json"}},r=>{let c="";r.on("data",u=>{c+=u}),r.on("end",()=>{if(r.statusCode===200)try{let u=JSON.parse(c);if(Array.isArray(u)&&u.length>0){let o=(u[0].name||"").replace(/^v/,"");if(o&&ct(a,o)){let n=`https://github.com/${ut}/${mt}/releases`;yt(o,n,t);return}}}catch{}if(e){let u=t?`Antigravity AI Cost is up to date (v${a}).`:`Antigravity AI Cost \u0111\xE3 l\xE0 phi\xEAn b\u1EA3n m\u1EDBi nh\u1EA5t (v${a}).`;R.window.showInformationMessage(u)}})}).on("error",()=>{})}async function yt(a,t,e){let i=e?"Download Update":"T\u1EA3i V\u1EC1 Ngay",r=e?"View Changelog":"Xem Chi Ti\u1EBFt",c=e?`\u{1F680} A new version of Antigravity AI Cost (v${a}) is available on GitHub!`:`\u{1F680} \u0110\xE3 c\xF3 phi\xEAn b\u1EA3n m\u1EDBi c\u1EE7a Antigravity AI Cost (v${a}) tr\xEAn GitHub!`,u=await R.window.showInformationMessage(c,i,r);(u===i||u===r)&&R.env.openExternal(R.Uri.parse(t))}var G,pt,gt,S=null,b,rt=null,lt=null,Z,Ct="all";function St(){let a=f.workspace.getConfiguration("antigravityCost"),t=(f.env.language.startsWith("vi"),"vi");return{language:a.get("language",t),currency:a.get("currency","USD"),vndExchangeRate:a.get("vndExchangeRate",25500),markupMultiplier:a.get("markupMultiplier",2.5),humanHourlyRate:a.get("humanHourlyRate",25),customPricing:a.get("customPricing",{})}}function Pt(){if(Z&&Z!=="CURRENT")return Z==="ALL"?void 0:Z;let a=f.workspace.workspaceFolders;if(a&&a.length>0)return a[0].uri.fsPath}async function M(a=!1,t,e){t!==void 0&&(Z=t),e!==void 0&&(Ct=e);let i=Pt();S=await G.scanWorkspace(i,Ct),pt.update(S,b),gt.updateReport(S,b),a&&S&&(b.language==="en"?f.window.showInformationMessage(`Antigravity Cost [${S.projectName}]: Scanned ${S.totalSessions} sessions (${T.formatNumber(S.totalTokens)} tokens, ~$${S.totalCostUSD.toFixed(3)})`):f.window.showInformationMessage(`Antigravity Cost [${S.projectName}]: \u0110\xE3 qu\xE9t ${S.totalSessions} sessions (${T.formatNumber(S.totalTokens)} tokens, ~$${S.totalCostUSD.toFixed(3)})`))}async function Q(a="markdown"){let t=Y(b.language);if(!S||S.totalSessions===0){f.window.showWarningMessage(b.language==="en"?"No cost data available to export.":"Ch\u01B0a c\xF3 d\u1EEF li\u1EC7u chi ph\xED \u0111\u1EC3 xu\u1EA5t b\xE1o c\xE1o.");return}let i=Pt()||f.Uri.file(process.cwd()).fsPath,r="PROJECT_VALUATION_REPORT.md",c="";a==="html"?(r="PROJECT_VALUATION_REPORT.html",c=T.generateHtml(S,b)):a==="json"?(r="project_cost_data.json",c=T.generateJson(S)):c=T.generateMarkdown(S,b);let u=ht.join(i,r);try{z.writeFileSync(u,c,"utf8");let m=t.openFile,o=t.reportExportSuccess.replace("{filename}",r);if(await f.window.showInformationMessage(o,m)===m){let d=await f.workspace.openTextDocument(f.Uri.file(u));await f.window.showTextDocument(d)}}catch(m){f.window.showErrorMessage(t.exportError.replace("{err}",m?.message||m))}}function Lt(){try{let a=ht.join(kt.homedir(),".gemini","antigravity-ide","brain");if(z.existsSync(a)){let t=null;lt=z.watch(a,{recursive:!0},(e,i)=>{i&&i.endsWith("transcript.jsonl")&&(t&&clearTimeout(t),t=setTimeout(()=>{M()},1500))})}}catch{}}function Vt(a){b=St(),G=new nt(b),pt=new ot,gt=new at(a.extensionUri,b,async(e,i)=>{await M(!0,e,i)},async e=>{await Q(e)},async e=>{b={...b,...e},G.updateConfig(b),S&&await M()}),a.subscriptions.push(f.window.registerWebviewViewProvider("antigravity-cost.sidebar",gt)),a.subscriptions.push(pt),a.subscriptions.push(f.commands.registerCommand("antigravity-cost.refresh",async()=>{await M(!0)})),a.subscriptions.push(f.commands.registerCommand("antigravity-cost.exportReport",async()=>{await Q("markdown")})),a.subscriptions.push(f.commands.registerCommand("antigravity-cost.exportHtmlReport",async()=>{await Q("html")})),a.subscriptions.push(f.commands.registerCommand("antigravity-cost.openDashboard",()=>{f.commands.executeCommand("antigravity-cost.sidebar.focus")})),a.subscriptions.push(f.commands.registerCommand("antigravity-cost.checkUpdate",async()=>{await st(a,b,!0)})),a.subscriptions.push(f.commands.registerCommand("antigravity-cost.menu",async()=>{let e=Y(b.language),i=[{id:"dashboard",label:e.menuOpenDashboard,description:e.menuOpenDashboardDesc},{id:"refresh",label:e.menuRefresh,description:e.menuRefreshDesc},{id:"export_md",label:e.menuExportMd,description:e.menuExportMdDesc},{id:"export_html",label:e.menuExportHtml,description:e.menuExportHtmlDesc},{id:"check_update",label:e.menuCheckUpdate,description:e.menuCheckUpdateDesc},{id:"toggle_currency",label:e.menuToggleCurrency,description:`Current: ${b.currency}`},{id:"toggle_language",label:e.menuToggleLanguage,description:`Current: ${b.language==="en"?"\u{1F1EC}\u{1F1E7} English":"\u{1F1FB}\u{1F1F3} Ti\u1EBFng Vi\u1EC7t"}`},{id:"settings",label:e.menuSettings,description:e.menuSettingsDesc}],r=await f.window.showQuickPick(i,{placeHolder:`Antigravity AI Cost & Valuation (${b.language.toUpperCase()})`});if(r)switch(r.id){case"dashboard":f.commands.executeCommand("antigravity-cost.sidebar.focus");break;case"refresh":await M(!0);break;case"export_md":await Q("markdown");break;case"export_html":await Q("html");break;case"check_update":await st(a,b,!0);break;case"toggle_currency":{let c=b.currency==="USD"?"VND":"USD";b.currency=c,G.updateConfig(b),await M(),f.window.showInformationMessage(b.language==="en"?`Switched currency to: ${c}`:`\u0110\xE3 \u0111\u1ED5i \u0111\u01A1n v\u1ECB ti\u1EC1n t\u1EC7 sang: ${c}`);break}case"toggle_language":{let c=b.language==="vi"?"en":"vi";b.language=c,G.updateConfig(b),await M(),f.window.showInformationMessage(c==="en"?"Switched language to English \u{1F1EC}\u{1F1E7}":"\u0110\xE3 \u0111\u1ED5i ng\xF4n ng\u1EEF sang Ti\u1EBFng Vi\u1EC7t \u{1F1FB}\u{1F1F3}");break}case"settings":f.commands.executeCommand("workbench.action.openSettings","antigravityCost");break}})),a.subscriptions.push(f.workspace.onDidChangeConfiguration(async e=>{e.affectsConfiguration("antigravityCost")&&(b=St(),G.updateConfig(b),await M())})),a.subscriptions.push(f.workspace.onDidChangeWorkspaceFolders(async()=>{await M()})),Lt(),setTimeout(()=>{M()},1e3),f.workspace.getConfiguration("antigravityCost").get("autoCheckUpdates",!0)&&setTimeout(()=>{st(a,b,!1)},3e3),rt=setInterval(()=>{M()},6e4)}function Ft(){rt&&(clearInterval(rt),rt=null),lt&&(lt.close(),lt=null)}0&&(module.exports={activate,deactivate});
