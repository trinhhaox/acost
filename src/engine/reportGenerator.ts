...
export class ReportGenerator {
    ...
    public static generateMarkdown(report: ProjectCostReport, config: PricingConfig): string {
        ...
        if (isEn) {
            ...
            md += `> **Measurement Tool:** Acost - AI Project Cost & Valuation Extension v1.3.0\n\n`;
            md += `---\n\n`;
            ...
            md += `\n---\n`;
            md += `*Report automatically generated by [Acost - AI Project Cost & Valuation Extension](file://${report.workspacePath}).*\n`;
            return md;
        }
        ...
        md += `> **Công cụ đo lường:** Acost - AI Project Cost & Valuation Extension v1.3.0\n\n`;
        md += `---\n\n`;
        ...
        md += `\n---\n`;
        md += `*Báo cáo được sinh tự động bởi [Acost - AI Project Cost & Valuation Extension](file://${report.workspacePath}).*\n`;
        return md;
    }
